...
- When working on projects, the specific tasks to tackle are written in tickets on Github Projects. Some current Lambda projects are working on other project management software, but these are legacy.
